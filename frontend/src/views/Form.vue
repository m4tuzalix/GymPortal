<template>
  <div class='container'>
    ...
    <b-form @submit.prevent='SendForm' @reset='onReset' class='mt-5'>
      <b-form-group
        id='input-group-1'
        label='Email address:'
        label-for='input-1'
      ...
      <b-form-textarea
        ...
        class='mt-5'
    ></b-form-textarea>
    <pre class='m-0' id='length' ref="counterField">{{max_length}}</pre>
    <div class='mt-5'>
  ...
  export default {
    ...
    methods: {
      ...
      onReset(evt) {
        ...
        this.description_length(true)
        // Trick to reset/clear native browser form validation state
      },
      description_length(event, clear=false){
        const counter = this.$refs.counterField
        if(clear){
          counter.innerHTML = this.max_length
        }
        else{
          counter.innerHTML = this.max_length - this.form.description.length
        }
      },
      async SendForm(){
        const params = {
